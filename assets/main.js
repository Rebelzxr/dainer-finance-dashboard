...
const I18N = {
  zh: {
    ...
    '// PROBE 02 · TELEGRAM TITLES':'// 探针 02 · Telegram 标题',
    '// PROBE 03 · WARNINGS':'// 探针 03 · 风险提醒',
    '// PROBE 03 · EVENTS':'// 探针 03 · 事件',
    '// PROBE 04 · EVENTS':'// 探针 04 · 事件',
    '// PROBE 04 · PORTFOLIO IMPACT':'// 探针 04 · 组合影响',
    '// PROBE 05 · PORTFOLIO IMPACT':'// 探针 05 · 组合影响',
    '// PROBE 05 · VALUATION':'// 探针 05 · 估值',
    '// PROBE 06 · VALUATION':'// 探针 06 · 估值',
    '// PROBE 06 · SOURCES':'// 探针 06 · 来源',
    '// PROBE 07 · SOURCES':'// 探针 07 · 来源',
    ...
    'DAILY TELEGRAM DIGEST':'每日 Telegram 摘要',
    ...
    "dailyTelegramTitle":"给 Telegram 的<br><em>标题</em>。",
    "dailyAutomationContract":"每日任务会研究、验证、写入 <span id=\"contract-json\">data/daily-brief.json</span> 和 telegram-news.txt，把完整本地报告存进 DAINER OS，提交并推送金融网站；每天早上发送 Telegram 标题摘要，风险项放最上面。",
